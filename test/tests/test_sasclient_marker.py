...
MARKER_STRING_EMPTY = '\x00\x1e\x03\x03\x00\x00\x01Q\xa5\x81Jv\x00\x00\x00\x00\x00\x00\x00o\x0f\x00\x00\xde\x00\x00\x00\x00\x00\x00'
MARKER_STRING_ONE_STATIC = '\x00"\x03\x03\x00\x00\x01Q\xa5\x81Jv\x00\x00\x00\x00\x00\x00\x00o\x0f\x00\x00\xde\x00\x00\x00\x00\x00\x04M\x01\x00\x00'
MARKER_STRING_TWO_STATIC = '\x00&\x03\x03\x00\x00\x01Q\xa5\x81Jv\x00\x00\x00\x00\x00\x00\x00o\x0f\x00\x00\xde\x00\x00\x00\x00\x00\x08M\x01\x00\x00\xbc\x01\x00\x00'
MARKER_STRING_ONE_VAR = '\x00.\x03\x03\x00\x00\x01Q\xa5\x81Jv\x00\x00\x00\x00\x00\x00\x00o\x0f\x00\x00\xde\x00\x00\x00\x00\x00\x00\x00\x0etest parameter'
MARKER_STRING_TWO_VAR = '\x00D\x03\x03\x00\x00\x01Q\xa5\x81Jv\x00\x00\x00\x00\x00\x00\x00o\x0f\x00\x00\xde\x00\x00\x00\x00\x00\x00\x00\x0etest parameter\x00\x14other test parameter'
MARKER_STRING_ALL = '\x00L\x03\x03\x00\x00\x01Q\xa5\x81Jv\x00\x00\x00\x00\x00\x00\x00o\x0f\x00\x00\xde\x00\x00\x02+\x00\x08M\x01\x00\x00\xbc\x01\x00\x00\x00\x0etest parameter\x00\x14other test parameter'
MARKER_STRING_BRANCH = ''
MARKER_STRING_TRACE = ''
MARKER_STRING_REACTIVATE = ''
...
class SASClientMarkerTest(SASClientTestCase):
    ...
    def test_ordering(self):
        ...
        marker_static_first.instance_id = 555
        ...
        marker_variable_first.instance_id = 555
    ...
    def test_interfaces(self):
        ...
        marker_plurals.instance_id = 555
        ...
        marker_singles.instance_id = 555
    ...
    def test_reactivate(self):
        marker = Marker(Trail(), 222).set_timestamp(TIMESTAMP)
        marker.set_association_scope(SCOPE_BRANCH).set_reactivate(True)
        assert marker.serialize() == MARKER_STRING_REACTIVATE
        pass

    def test_reactivate_scope_none(self):
        marker = Marker(Trail(), 222).set_timestamp(TIMESTAMP)
        marker.set_reactivate(True)
        assert marker.serialize() == MARKER_STRING_EMPTY
        pass